...
const caseStudies = [
  {
    ...
    summary: "A multi-location practice streamlined operations and improved care coordination across specialties using MD Charts integrated platform.",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              Discover how medical practices across specialties have transformed their operations with MD Charts EHR.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Join practices across the country that have transformed their operations with MD Charts.
          </p>
          <Link href="/book-demo">
