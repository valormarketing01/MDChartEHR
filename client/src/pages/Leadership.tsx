...
const leaders = [
  {
    ...
    description: "Our executive team brings together decades of experience in healthcare technology, medical practice management, and software development to drive MD Charts' mission forward."
  },
  {
  ...
  },
  {
    ...
    description: "Our customer success team is dedicated to ensuring every practice gets the most from their MD Charts investment through training, support, and ongoing optimization."
  },
  {
    name: "Engineering",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              Meet the teams driving innovation and excellence at MD Charts EHR.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-3xl mx-auto">
            Every member of the MD Charts team is committed to our mission of helping medical practices deliver exceptional patient care. We believe in building long-term partnerships with our customers and continuously improving our solutions based on their feedback.
          </p>
        </div>
      </section>
