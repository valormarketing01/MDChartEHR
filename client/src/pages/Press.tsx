...
const pressReleases = [
  {
    title: "MD Charts Announces Enhanced Specialty EHR Solutions",
    date: "Recent",
    summary: "Expanded specialty-specific templates and workflows for improved clinical documentation."
  },
  {
    title: "MD Charts Continues Commitment to Regulatory Compliance",
    date: "Recent",
  ...
  {
    title: "MD Charts Launches Enhanced Patient Portal",
    date: "Recent",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6">
              MD Charts <span className="text-primary">Newsroom</span>
            </h1>
            
            <p className="text-xl text-slate-600 mb-8 leading-relaxed">
              Stay up to date with the latest news and announcements from MD Charts EHR.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-slate-600 mb-6">
                Members of the media can contact our communications team for information about MD Charts, interview requests, or other press-related inquiries.
              </p>
              <Link href="/contact">
